...
export default function Landing() {
  ...
  <div id="landing-container">
    ...
    <header id="header">
      ...
      <nav className={navClosed ? "closed" : ""}>
    ...
    <section id="q_a">
      ...
      <section>
        ...
        <p>Using drones we can deliver small packages (less then 15 kg) through air.
          Using transport rout we avoid overloaded ground routs, 
      ...
      <section>
        ...
        <p>Drones become more and more cheap. Even big drones, that are
          necessary to carry packages, cost not much. Due to using drones as currier even
